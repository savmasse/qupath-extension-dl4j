...
import qupath.lib.deep_learning.NeuralNetworkExample;
 ...
 *
 */
public class TestCommand implements PathCommand, ImageDataChangeListener<BufferedImage>, PropertyChangeListener {
...
//	private float maxCurrent = 0;
    ...
    public TestCommand (final QuPathGUI qupath) {
        this.qupath = qupath;
    ...
    protected Stage createDialog() {
        ...
        // Test the DL4J functions
        try {
            NeuralNetworkExample.run();
        } catch (IOException e) {
            e.printStackTrace();
        }
